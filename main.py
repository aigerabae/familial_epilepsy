...
mask = np.strings.contains(data['SIFT'], sift_keyword) & np.strings.contains(data['PolyPhen'], polyphen_keyword) & np.strings.contains(data['Clinvar'], clinvar_keyword) 
pathogenic_variants = data[mask]
